...
namespace JardisCore\DbSchema\repository;

use JardisPsr\DbSchema\DbSchemaInterface;
use PDO;

/**
 * A class that provides schema-level operations for SQLite databases,
 * including interaction with tables, columns, indexes, foreign keys, and types.
 */
class SqLite implements DbSchemaInterface
{
    private PDO $pdo;
