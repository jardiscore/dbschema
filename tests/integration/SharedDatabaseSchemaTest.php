...
use JardisCore\DbSchema\Adapter\MySql;
use JardisCore\DbSchema\Adapter\Postgres;
use JardisCore\DbSchema\Adapter\SqLite;
...
class SharedDatabaseSchemaTest extends TestCase
{
    ...
    public function testPostgresConstructor(): void
    {
        ...
        $repository = new Postgres($pdo);

        $this->assertInstanceOf(Postgres::class, $repository);
        $this->assertInstanceOf(DbSchemaInterface::class, $repository);
    }
    ...
    public function testSqLiteConstructor(): void
    {
        ...
        $repository = new SqLite($pdo);

        $this->assertInstanceOf(SqLite::class, $repository);
        $this->assertInstanceOf(DbSchemaInterface::class, $repository);
    }
    ...
    public function testTables(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaInterface $repository): void
    {
        ...
        $this->assertCount(2, $tables, "Should return exactly 2 tables (users, orders)");
        ...
        $this->assertEquals(['orders', 'users'], $tableNames, "Tables should be in alphabetical order");
    }

    /**
     * @dataProvider databaseProvider
     * @covers \JardisCore\DbSchema\Adapter\MySql::columns
     * @covers \JardisCore\DbSchema\Adapter\Postgres::columns
     * @covers \JardisCore\DbSchema\Adapter\SqLite::columns
     */
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisCore\DbSchema\Adapter\MySql::indexes
     * @covers \JardisCore\DbSchema\Adapter\Postgres::indexes
     * @covers \JardisCore\DbSchema\Adapter\SqLite::indexes
     */
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisCore\DbSchema\Adapter\MySql::foreignKeys
     * @covers \JardisCore\DbSchema\Adapter\Postgres::foreignKeys
     * @covers \JardisCore\DbSchema\Adapter\SqLite::foreignKeys
     */
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisCore\DbSchema\Adapter\MySql::fieldType
     * @covers \JardisCore\DbSchema\Adapter\Postgres::fieldType
     * @covers \JardisCore\DbSchema\Adapter\SqLite::fieldType
     */
